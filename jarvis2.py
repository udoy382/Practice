...
def play_music():
    speak("Playing Justin Bieber's music on YouTube...")
    search_query = "Justin Bieber"
    url = f"https://www.youtube.com/results?search_query={search_query}"
    webbrowser.open(url)
    time.sleep(3)  # Wait for the page to load
    play_button_xpath = '//*[@id="video-title"]/yt-formatted-string'
    play_button = driver.find_element_by_xpath(play_button_xpath)
    play_button.click()
...
def jarvis():
    ...
    while True:
        ...
        elif "play Justin Bieber music" in text:
            play_music()
